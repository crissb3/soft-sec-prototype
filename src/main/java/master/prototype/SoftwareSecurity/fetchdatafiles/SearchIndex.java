...
public class SearchIndex {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        //Search by firstName
        TopDocs foundDocs2 = searchByFirstName("Alex", searcher);
        ...
        for (ScoreDoc sd : foundDocs2.scoreDocs)
        {
            ...
            System.out.println("Firstname: " + String.format(d.get("firstName")));
            System.out.println("Lastname: " + String.format(d.get("lastName")));
            System.out.println("Website: " + String.format(d.get("website")));
        }

        //Search by website
        TopDocs foundDocs3 = searchByWebsite("testwebsite.com", searcher);
